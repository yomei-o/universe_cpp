...
| 📡 | [レーダーを amr に載せる](https://yomei-o.github.io/universe_cpp/wasmdist/radaramr_os/) | 同じ物理でも必要な格子階層が座標で違う。pg 8 レベル / iso 6 レベル、観測量は 12 桁同じ |
| 🧱 | [amr・数値相対論の計算法](https://yomei-o.github.io/universe_cpp/wasmdist/amr_os/) | Berger-Oliger 多層格子＋時間細分化。方程式は波でも機械は本物。4 次で収束 |
